...
public class Offer {
    ...
    /** Unique identifier of the offer (auto-generated by the database). */
    @Id
    ...
    /** Timestamp when the offer was created. Automatically set by the database on insert and never updated. */
    @CreationTimestamp
